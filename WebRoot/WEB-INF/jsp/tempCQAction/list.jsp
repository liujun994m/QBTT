		...
		<div class="tree" style="margin-top:20px;">
			<ul id="tree" class="filetree">
				...
				<s:if test="#session.operator.hasAreaByName(name)">
					<li>
						<div id="contentid">
							<s:a action="tempCQ_centerList?areaId=%{id}"  target="right" style="font-size:15px;" ><i class="fa  fa-square-o"></i>&nbsp;${name}</s:a>
						</div> <!-- 区域的树形结构 -->
						<ul>
							<s:iterator value="centers">
								<li>
									<div id="contentid">
										<s:a action="tempCQ_deviceList?centerId=%{id}"  target="right" style="font-size:15px;"><i class="fa  fa-building-o"></i>&nbsp;${name}</s:a>
									</div>
								</li>
