...
<body>
	...
	<div id="container">
		<table class="table-edit">
			...
			<%-- <s:else>
            	<s:form  action="device_edit">
            	<s:form action="" name="form" method="post">
            	<s:hidden name="id" />
            	   <tr>
                    	<td>表号&nbsp;</td>
                         <td><s:textfield name="deviceNo" class="InputStyle"/> *</td>
                         <td><s:fielderror><s:param>deviceNo</s:param></s:fielderror></td>
                    </tr>
                     <tr>
                    	<td>表名称&nbsp;</td>
                         <td><s:textfield name="name" class="InputStyle"/> *</td>
                    ...
                    <tr>
                    	<td>型号&nbsp;</td>
                         <td>
                         	<s:select name="deviceTypeID" cssClass="SelectStyle"
                        		list="#deviceTypes" listKey="id" listValue="name+'('+manufacture+')'" 
                        		headerKey="" headerValue="===请选择水表型号===" /> *</td>
                         <s:textfield name="deviceTypeID" class="InputStyle"/> *</td>
                    </tr>
                    <tr>
                    	<td>最大值&nbsp;</td>
                         <td><s:textfield name="MaxNum" class="InputStyle"/> *请输入数字</td>
                    ...
                    <tr>
                    	<td>倍率&nbsp;</td>
                         <td><s:textfield name="imultiple" class="InputStyle"/> *请输入数字
                         </td>
                    </tr>
                    <tr>
                    	<td>告警&nbsp;</td>
                         <td>
                              <s:select name="needAlarm" cssClass="SelectStyle"
                        		list="#{0:'不需要',1:'需要'}"  listKey="key" listValue="value" 
                        		headerKey="" headerValue="===请选择是否需要告警===" /> *
                         </td>
                    </tr>
                    <tr>
                    	<td>告警类型&nbsp;</td>
                         <td>
                          <s:select name="alarmGetType" cssClass="SelectStyle"
                        		list="#{0:'取当前值',1:'取用量'}"  listKey="key" listValue="value" 
                        		headerKey="" headerValue="===请选择告警类型===" /> *
                         </td>
                    </tr>
                    <tr>
                    	<td>告警上限&nbsp;</td>
                    ...
                    <tr>
                    	<td>是否使用&nbsp;</td>
                         <td>
                         	<s:select name="StopUse" cssClass="SelectStyle"
                        			list="#isUse" listKey="key" listValue="value"  />*
                         </td>
                    </tr>
                    <tr>
                    	<td>计费类型&nbsp;</td>
                         <td>
                         	<s:select name="GetMoneyType" cssClass="SelectStyle" 
                        		list="#{0:'不计费',1:'实时收费',2:'按月收费'}"  listKey="key"  listValue="value" 
                        		headerKey=""  headerValue="===请选择计费方式===" /> *
                         </td>
                    </tr>
                    <tr>
                    	<td>用量计算方法&nbsp;</td>
                         <td>
                         	<s:select name="UserCountType"  cssClass="SelectStyle" 
                        		list="#{0:'不计用量',1:'上次抄读',2:'每天',3:'每月'}"  listKey="key"  listValue="value" 
                        		headerKey=""  headerValue="===请选择用量计算方式===" /> *
                         </td>
                    </tr>
                    <tr>
                    	<td>条码&nbsp;</td>
