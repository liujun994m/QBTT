...
<script type="text/javascript">
	function a() {
		...
		if (id.length > 1) {
			document.form.action = "device_edit.action?centerId=" + ${centerId};
...
<body>
	...
	<div id="container">
		<table class="table-edit">
			...
			<s:hidden name="centerId"></s:hidden>
			...
			<tbody>
				...
				<s:form action="" name="form" method="post">
					...
					<tr>
						<td>告警上限&nbsp;</td>
						<td><s:textfield name="alarmMax" class="InputStyle" />
							*请输入数字</td>
					</tr>
					<tr>
						<td>告警下限&nbsp;</td>
						<td><s:textfield name="alarmMin" class="InputStyle" />
							*请输入数字</td>
					</tr>
					<tr>
						<td>是否使用&nbsp;</td>
			...
			<tfoot>
				<tr>
					<td colspan="5"><input type="button" value="保存" style="cursor:hand"
						onclick="a();"></td>
				</tr>
		</table>
	</div>
